...
import { RectangleVerticalIcon, Loader2Icon, Wand2Icon, RectangleHorizontalIcon } from "lucide-react"
      ...
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
            ...
            <div className="flex flex-col w-full sm:max-w-60 gap-8 mt-8 mb-12">
                ...
                onClear={()=> setProductImage(null)} onChange={(e) => handleFileChange(e, 'model')} />
            </div>
            {/* right col */}
            <div className="w-full">
                ...
                <div className="mb-4 text-gray-300">
                    ...
                    <textarea rows={4}  id="productDescription" value={productDescription} onChange={(e) => setProductDescription(e.
                    target.value)} placeholder="Enter the description og the product" required 
                ...
                <div className="mb-4 text-gray-300">
                    ...
                    <textarea rows={4}  id="userPrompt" value={userPrompt} onChange={(e) => setUserPrompt(e.
                    target.value)} placeholder="Enter the description og the product" required 
                    className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"/>
                </div>
