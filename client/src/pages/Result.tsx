...
import { Loader2Icon, SparkleIcon, RefreshCwIcon, ImageIcon, VideoIcon } from "lucide-react"
...
const Result = () => {
  ...
  return loading ? (
    <div className="h-screen w-full flex items-center justify-center">
      <Loader2Icon className="animate-spin text-indingo- size-9" />
    </div>
  ) : (
        ...
        <div className="grid lg:grid-cols-3 gap-8" >
          ...
          <div className="space-y-6">
            ...
            <div className="glass-panel p-6 rounded-2xl relative overflow-hidden" >
              <div className="abolute top-0 right-0 p-4 opacity-10">
