...
import { Loader2Icon, Share2Icon, Trash2Icon, EllipsisIcon, ImageIcon, PlaySquareIcon } from "lucide-react";
                ...
                group-hover:opacity-100 transition flex items-center gap-2" >
                    ...
                    <div className="flex flex-col items-end w-32 text-sm">
                        ...
                        rounded-lg shadow-md mt-2 py-1 z-10`}>
                            ...
                            onClick={() => navigator.share({url: gen.generatedVideo || gen.generatedImage, title: gen.
